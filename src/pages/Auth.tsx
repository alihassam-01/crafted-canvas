...
import { Eye, EyeOff, Mail, Lock, User, ArrowLeft, ShoppingBag } from 'lucide-react';
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        navigate(response.data.user.role === 'SELLER' ? '/dashboard' : '/');
      } else {
        toast({
          variant: "destructive",
          title: "Login failed",
    ...
    try {
      ...
      if (response.success) {
        ...
        toast({
          ...
          description: "Welcome to Crevea.",
        });
        navigate(isSeller ? '/dashboard' : '/');
      } else {
        toast({
          variant: "destructive",
                  ...
                  <div className="flex items-center space-x-2 border p-4 rounded-md">
                    ...
                    <div className="grid gap-1.5 leading-none">
                      ...
                      <p className="text-sm text-muted-foreground">
                        I want to open a shop and sell products
                      </p>
                    </div>
                  </div>
        ...
        <div className="hidden lg:flex flex-1 bg-gradient-hero items-center justify-center p-12">
          <div className="max-w-md text-center">
            <div className="w-24 h-24 mx-auto mb-8 rounded-full bg-gradient-warm flex items-center justify-center">
              <span className="text-primary-foreground font-display text-4xl">A</span>
            </div>
